                            ...
                            <form onSubmit={save}>
                                <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                    <div className="w-full">
                                        ...
                                        <input value={eventSelected?.name} onChange={(e) => setName(e.target.value)} type="text" name="name" id="name"
                                    ...
                                    <div className="w-full">
                                        ...
                                        <input value={eventSelected.players}  onChange={(e) => setPlayers(e.target.value)} type="number" name="players" id="players"
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:bg-white block w-full p-2.5"
                                            required/>
                                    </div>
                                    ...
                                    <div className="w-full">
                                        ...
                                        <input value={eventSelected?.date}  onChange={(e) => setDate(e.target.value)} type="date" name="date" id="date"
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:bg-white block w-full p-2.5"
                                            required/>
                                    </div>
                                    ...
                                    <div className="w-full">
                                        ...
                                        <input value={eventSelected?.time} onChange={(e) => setTime(e.target.value)} type="time" name="time" id="time"
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:bg-white block w-full p-2.5"
                                            required/>
                                    </div>
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <textarea value={eventSelected?.description}  onChange={(e) => setDescription(e.target.value)} id="description" rows={6}
