                                    ...
                                    <div className="flex justify-around">
                                        <div className="flex flex-col">
                                            <div className="py-4">
                                                ...
                                                <p className="capitalize">{party[0].dateParty}</p>
                                            </div>
                                        </div>

                                        <div className="flex flex-col">
                                            <p className="font-semibold">Lieu :</p>
                                            <p className="capitalize py-4">{party[0].location}</p>
                                        </div>
                                    </div>

                                    <div className="2xl:absolute bottom-0 left-0 flex justify-around w-full">
                                        {party[0].status !== -1 &&
                                        ...
                                        <Modal.Body>
                                            <div className="text-center">
                                                ...
                                                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    Voulez-vous vraiment refuser cette fête ?
                                                </h3>
                                                {isLoader ?
                                    ...
                                    >
                                        ...
                                        <Modal.Body>
                                            <div className="text-center">
                                                ...
                                                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    Voulez-vous vraiment publier cette fête ?
                                                </h3>
                                                {isLoader ?
                                                    <svg aria-hidden="true"
                                                        className="inline w-8 h-8 text-gray-200 animate-spin fill-gray-600"
