...
export default function Category() {
    ...
    const openDeleteModal = useCallback( async (category:Category) => {
                                        ...
                                        return (
                                            ...
                                            <tr key={index} className={index % 2 == 0 ? ' bg-white' : ' bg-gray-50'}>
                                                ...
                                                <td className="px-6 py-3 flex">
                                                    ...
                                                    <svg onClick={ () => openDeleteModal(category)}  fill="none" className="w-6 h-6 stroke-red-500 cursor-pointer" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
