                    ...
                    <div className="container mx-auto pt-10 h-screen">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 h-4/6">
                                ...
                                <div className="md:col-span-7 md:col-start-7 my-10 relative">
                                    <h2 className="mb-2 font-semibold leading-none text-gray-900 text-5xl">{event[0]?.name}</h2>
                                    <dl className="mt-16">
                                        <dt className="mb-2 font-semibold leading-none text-gray-900 text-2xl">{event[0]?.description}</dt>
