...
export default function AdminHeader() {
    ...
    return (
        <>
            <nav
                className="fixed top-0 z-50 w-full bg-white border-b border-blue-300 dark:bg-gray-800 dark:border-gray-700">
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" onClick={() => setDisplay(!display)}
                            ...
                            <Link href="/admin" className="flex items-center">
                                <Image src="/otter.png" alt="logo"
                                       className="w-14 h-14 lg:w-13 lg:h-13 hover:duration-1000 hover:rotate-[360deg]"
            ...
            <aside
                className={`fixed top-20 left-0 z-40 w-64 h-screen transition-transform bg-white border-r border-blue-300 dark:bg-gray-800 dark:border-gray-700 ${display ? 'translate-x-0' : 'sm:translate-x-0 -translate-x-full'}`}
                aria-label="Sidebar">
                <div className="h-full px-3 pb-4 overflow-y-auto dark:bg-gray-800 mt-6">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link href="/admin/user"
                                ...
                                <svg aria-hidden="true"
                                     ...
                                     fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 20 20"
                                     xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            <Link href="/admin/company/request"
                                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg
                                    className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                    fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"
                        ...
                        <li>
                            <span
                                ...
                                <span onClick={handleLogout} className="flex-1 ml-3 whitespace-nowrap">Déconnexion</span>
                            </span>
                        </li>
                    </ul>
                </div>
