export default function Chat() {
    return (
        <>
            <div
                className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 dark:border-gray-700 dark:bg-gray-800 xl:mb-0">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Smart chat</h3>
                    <a href="web-app/components/examples#"
                ...
                <form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
                    <article className="mb-5">
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                    <time dateTime="2022-02-08"
                                          title="February 8th, 2022"> 01/03/2023 4:15 PM
                                    </time>
                                </p>
                            </div>
                        ...
                        <p className="mb-2 text-gray-900 dark:text-white">
                            Hello <a href="web-app/components/examples#"
                                     className="font-medium hover:underline text-primary-600 dark:text-primary-500">@designteam</a> Let's
                            schedule a kick-off meeting and workshop this week. It would be great to gather
                            everyone involved in the design project. Let me know about your availability in
                            the thread.
                        </p>
                    ...
                    <article className="mb-5">
                        ...
                        <div className="flex items-center mb-2 space-x-2">
                            <button type="button"
                                ...
                                <svg aria-hidden="true" className="h-5 mr-2" viewBox="0 0 24 27" fill="none"
                                ...
                                <span
                                    className="text-sm font-medium text-gray-500 dark:text-gray-400">14</span>
                            </button>
                            <button type="button"
                                    className="py-1.5 px-3 inline-flex items-center rounded-lg bg-gray-100 hover:bg-gray-200 dark:hover:bg-gray-600 dark:bg-gray-700">
                                <svg aria-hidden="true" className="h-5 mr-2" viewBox="0 0 24 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <span
                                    className="text-sm font-medium text-gray-500 dark:text-gray-400">8</span>
                            </button>
                            <button type="button"
                                    className="py-1.5 px-3 inline-flex items-center rounded-lg bg-gray-100 hover:bg-gray-200 dark:hover:bg-gray-600 dark:bg-gray-700">
                                <svg aria-hidden="true" className="h-5 mr-2" viewBox="0 0 24 25" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <span
                                    className="text-sm font-medium text-gray-500 dark:text-gray-400">3</span>
                            </button>
                        </div>
                    </article>
                    <article className="mb-5">
                        ...
                        <p className="mb-2 text-gray-900 dark:text-white">
                            Ok <a href="web-app/components/examples#"
                                  className="font-medium hover:underline text-primary-600 dark:text-primary-500">@team</a> I'am
                        ...
                        <div className="items-center 2xl:space-x-4 2xl:flex">
                            {/* Item */}
                            <div
                                className="flex items-center p-3 mb-3.5 border border-gray-200 dark:border-gray-700 rounded-lg">
                                <div
                                    className="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-primary-100 dark:bg-primary-900">
                                    <svg
                            ...
                            <div
                                className="flex items-center p-3 mb-3.5 border border-gray-200 dark:border-gray-700 rounded-lg">
                                <div
                                    className="flex items-center justify-center w-10 h-10 mr-3 bg-teal-100 rounded-lg dark:bg-teal-900">
                                    <svg className="w-5 h-5 text-teal-600 lg:w-6 lg:h-6 dark:text-teal-300"
                                         fill="currentColor" viewBox="0 0 20 20"
                                         xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                        <path
                                ...
                                <div className="mr-4">
                                    ...
                                    <p className="text-sm text-gray-500 dark:text-gray-400">PPTX, 10.1
                                        MB</p>
                                </div>
                                <div className="flex items-center ml-auto">
                                    <button type="button" className="p-2 rounded hover:bg-gray-100">
                    ...
                    <article className="pl-12 mb-5">
                        ...
                        <p className="mb-2 text-gray-900 dark:text-white">
                            Hello <a href="web-app/components/examples#"
                                     className="font-medium hover:underline text-primary-600 dark:text-primary-500">@jeseleos</a> I
                    ...
                    <article className="pl-12 mb-5">
                        ...
                        <p className="mb-4 text-gray-900 dark:text-white">
                            Hi <a href="web-app/components/examples#"
                                  className="font-medium hover:underline text-primary-600 dark:text-primary-500">@josephh</a> Sure,
                        ...
                        <div className="flex items-center mb-5">
                                        <textarea id="chat" rows={1}
                                                  ...
                                                  placeholder="Reply in thread..." defaultValue={""}/>
                            <button type="submit"
                        ...
                        <span
                            className="inline-flex items-center text-xs font-medium cursor-pointer hover:underline text-primary-700 sm:text-sm dark:text-primary-500">
                    Hide thread
                    <svg className="w-5 h-5 ml-1" fill="currentColor" viewBox="0 0 20 20"
                         xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      <path clipRule="evenodd" fillRule="evenodd"
                ...
                <div
                    ...
                    <div className="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                        ...
                        <textarea id="comment" rows={8}
                                  ...
                                  placeholder="Write your message" required defaultValue={""}/>
                    </div>
                    <div
