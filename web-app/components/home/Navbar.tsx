                    ...
                    {session ? (
                        <>
                            <button onClick={handleLogout}
                                    className="text-custom-dark bg-custom-white border-2 border-custom-orange hover:bg-custom-hover-orange hover:text-white focus:outline-none font-medium rounded-lg text-base py-2 px-4 md:py-2 text-center mr-0">Déconnexion
                            </button>
                        </>
                            ...
                            <>
                                <li>
                                    <Link href="/me/announcement"
                                       className="text-custom-dark border-2 border-custom-light-orange hover:border-solid hover:bg-white hover:border-custom-highlight-orange focus:outline-none font-medium rounded-lg text-sm lg:text-base px-4 py-3 text-center"
                                       aria-current="page">Mes annonces</Link>
                                </li>
                                <li>
