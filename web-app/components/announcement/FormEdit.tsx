                    ...
                    <div className="py-8 px-10 mx-auto my-24 max-w-4xl rounded-lg lg:py-16 bg-white">
                        ...
                        <form onSubmit={save}>
                            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                <div className="w-full relative">
                                    ...
                                    <div ref={dropdownRef}>
                                        <button id="categories"
                                                onClick={() => setShowListCategories(!showListCategories)}
                                ...
                                <div className="w-full">
                                    <label htmlFor="brand"
                                           className="block mb-2 text-sm font-medium text-gray-900">Type de
                                        l'annonce</label>

                                    <div className="flex pt-3">
                                        <div className="flex items-between mr-4">
                                            <input defaultChecked={type === 'location'}
                                                   onChange={(e) => setType(e.target.value)} id="location"
                                                   type="radio"
                                        ...
                                        <div className="flex items-center mr-4">
                                            <input defaultChecked={type === 'sale'}
                                                   onChange={(e) => setType(e.target.value)} id="sale" type="radio"
                                                   value="sale"
