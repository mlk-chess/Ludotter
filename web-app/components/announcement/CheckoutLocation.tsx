        ...
        <>
            <div className="bg-white rounded p-4">
                ...
                <div>
                    <div className="my-6">
                        <label htmlFor=""
                               className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sélectionnez les dates</label>
                        <Datepicker
                            i18n={"fr"}
                            startWeekOn="mon"
                            minDate={new Date(new Date().getTime() + 24 * 60 * 60 * 1000).toISOString().slice(0, 10)}
                            value={value}
                            startFrom={new Date()}
